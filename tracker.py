"""
================================================================================
Python Assignment - ATTENDANCE TRACKER 
================================================================================
Name: Ayush Raj
Roll No: 2501940005
Course: MCA (AI & ML)
...
def validate_time(time_str):
    ...
    if len(time_str) < 4:
        return False, f"{Colors.WARNING}Warning: Time format seems invalid. \nPlease use format like '09:10 AM'{Colors.ENDC}"
    
    return True, ""


def collect_attendance():
    attendance = {}  #Returns: dictionary of attendance records
    
    # For getting number of entries
    while True:
        try:
...
def main():
    ...
    #for showing the result in a txt-file 
